...
/* ------------------------------------------------------------------
 *  Conditional imports — only loaded when the feature is enabled.
 *  To remove a feature permanently: set it to `false` in
 *  features.config.js, then delete its folder if you want.
 * ------------------------------------------------------------------ */
